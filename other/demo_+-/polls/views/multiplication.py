...
@extend_schema(
    parameters=[
        OpenApiParameter("a", OpenApiTypes.FLOAT, OpenApiParameter.QUERY, description="第一个因子"),
        OpenApiParameter("b", OpenApiTypes.FLOAT, OpenApiParameter.QUERY, description="第二个因子"),
    ],
    responses={
        200: {
            "type": "object",
