...
@extend_schema(
    parameters=[
        OpenApiParameter("a", OpenApiTypes.FLOAT, OpenApiParameter.QUERY, description="被减数"),
        OpenApiParameter("b", OpenApiTypes.FLOAT, OpenApiParameter.QUERY, description="减数"),
    ],
    responses={
        200: {
            "type": "object",
